...
def main():
    ...
    tests = [
        ...
        (["uv", "run", "gemini-cli", "status", "templates"], "Status templates command"),
        ...
        # JSON output tests
        (["uv", "run", "gemini-cli", "--json", "status", "config"], "JSON config output"),
        (["uv", "run", "gemini-cli", "--json", "status", "templates"], "JSON templates output"),
        
        # Global options tests
        (["uv", "run", "gemini-cli", "--verbose", "status", "config"], "Verbose config"),
        (["uv", "run", "gemini-cli", "--no-color", "status", "config"], "No color config"),
    ]
